...
export const DocumentViewer: React.FC<DocumentViewerProps> = ({ filePath, onTextSelected }) => {
  ...
  return (
    <div onMouseUp={handleMouseUp} style={{ padding: '20px', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
